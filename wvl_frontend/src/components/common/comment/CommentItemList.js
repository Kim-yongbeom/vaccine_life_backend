    ...
    <>
      {commentInfo && (
        <CommentItemBlock>
          ...
          <CommentContent>{commentInfo.commentContent}</CommentContent>
          <CommentItemDate>
            {commentInfo.updatedDate
              ? dayjs(commentInfo.updatedDate).format("YYYY년 MM월 DD일")
              : dayjs(commentInfo.commentDate).format("YYYY년 MM월 DD일")}
          </CommentItemDate>
        </CommentItemBlock>
      )}
    </>
