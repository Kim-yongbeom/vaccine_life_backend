...
function EditProfile({ onChangeDropDown, onClickAvatar, defaultOption }) {
  return (
    <EditProfileWrap>
      <EditItemBlock>
        <EditLabelWrap>
      ...
      <EditItemBlock>
        ...
        <StyledDropDown
          ...
          onChangeDropDown={onChangeDropDown.gender}
        />
      </EditItemBlock>
      <EditItemBlock>
        <EditLabelWrap>
        ...
        <StyledDropDown
          ...
          onChangeDropDown={onChangeDropDown.type}
        />
      </EditItemBlock>
      <EditItemBlock>
        <EditLabelWrap>
        ...
        <StyledDropDown
          ...
          options={["1차 접종", "2차 접종"]}
          defaultOption={defaultOption.degree}
          onChangeDropDown={onChangeDropDown.degree}
        />
      </EditItemBlock>
      <EditItemBlock>
        <EditLabelWrap>
